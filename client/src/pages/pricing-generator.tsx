    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              {formData && (
                <ErrorBoundary sectionName="PDF Generator">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Form Section - Isolated Container */}
          <div className="lg:col-span-2 pricing-form-container">
            <ErrorBoundary sectionName="Pricing Form">
              <div className="isolated-section" data-section="pricing-form">
                <PricingForm 
          ...
          {/* Preview Section - Isolated Container */}
          <div className="lg:col-span-1 preview-container">
            <ErrorBoundary sectionName="Live Preview">
              <div className="isolated-section" data-section="live-preview">
                {formData ? (
                  <LivePreview 
                  ...
                  <div className="bg-white rounded-xl shadow-sm border p-6 sticky top-8">
                    <h3 className="text-lg font-semiblement text-gray-900 mb-4">Live Preview</h3>
